    ...
    (e = {
      ...
      976: (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.arrayDiff = void 0);
        var r = new (
          (i = n(913)) && i.__esModule ? i : { default: i }
        ).default();
        (t.arrayDiff = r),
      ...
      913: (e, t) => {
        ...
        function i(e, t, n, i, r) {
          for (var s = 0, o = t.length, a = 0, l = 0; s < o; s++) {
            ...
            if (c.removed) {
              if (
                ((c.value = e.join(i.slice(l, l + c.count))),
                (l += c.count),
                s && t[s - 1].added)
              ) {
                var d = t[s - 1];
                  ...
                  if (p || b) {
                    if (
                      (!p || (b && d.newPos < u.newPos)
                        ...
                        : ((r = d).newPos++,
                          s.pushComponent(r.components, !0, void 0)),
      ...
      276: (e, t, n) => {
        ...
        function c(e, t, n, i, r) {
          ...
          if (
            (e && e.toJSON && (e = e.toJSON()), "object" === o(e) && null !== e)
          ) {
            t.push(e), (l = {}), n.push(l);
            var d,
              f = [];
        ...
        (t.jsonDiff = l),
          ...
          (l.castInput = function (e) {
            ...
            return "string" == typeof e
              ? e
              : JSON.stringify(c(e, null, null, r), r, "  ");
          }),
      ...
      303: (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.diffWords = function (e, t, n) {
            return (
              (n = (0, s.generateOptions)(n, { ignoreWhitespace: !0 })),
              l.diff(e, t, n)
            );
          }),
                  ...
                  if (((t.lines = i), t.added || t.removed)) {
                    ...
                    if (!f) {
                      ...
                      (f = p),
                        ...
                        a &&
                          ((h =
                            l.context > 0 ? v(a.lines.slice(-l.context)) : []),
                          (f -= h.length),
                          (u -= h.length));
                    }
                    (o = h).push.apply(
      ...
      51: (e, t, n) => {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.merge = function (e, t, n) {
            ...
            for (
              var r = 0, s = 0, o = 0, a = 0;
              r < e.hunks.length || s < t.hunks.length;

            ) {
              var l = e.hunks[r] || { oldStart: 1 / 0 },
                b = t.hunks[s] || { oldStart: 1 / 0 };
              if (u(l, b))
                i.hunks.push(h(l, o)), r++, (a += l.newLines - l.oldLines);
              else if (u(b, l))
                i.hunks.push(h(b, a)), s++, (o += b.newLines - b.oldLines);
              else {
                var g = {
                ...
                p(g, l.oldStart, l.lines, b.oldStart, b.lines),
                  s++,
                  r++,
                  i.hunks.push(g);
              }
        ...
        function l(e) {
          ...
          void 0 !== n ? (e.oldLines = n) : delete e.oldLines,
            void 0 !== i ? (e.newLines = i) : delete e.newLines;
        }
        function c(e, t) {
          if ("string" == typeof e) {
        ...
        function p(e, t, n, i, r) {
          ...
          for (
            v(e, s, a), v(e, a, s);
            s.index < s.lines.length && a.index < a.lines.length;
        ...
        function g(e, t, n, i) {
          var r,
            ...
            a = (function (e, t) {
              for (
                var n = [], i = [], r = 0, s = !1, o = !1;
                r < t.length && e.index < e.lines.length;
          ...
          a.merged
            ? (r = e.lines).push.apply(r, o(a.merged))
            : m(e, i ? a : s, i ? s : a);
        }
        function m(e, t, n) {
            ...
            e.forEach(function (e) {
              if ("string" != typeof e) {
                var i = C(e.mine),
                  r = C(e.theirs);
                void 0 !== t &&
                  (i.oldLines === r.oldLines
                    ? (t += i.oldLines)
                    : (t = void 0)),
                  void 0 !== n &&
                    (i.newLines === r.newLines
                      ? (n += i.newLines)
                      : (n = void 0));
              } else
                void 0 === n || ("+" !== e[0] && " " !== e[0]) || n++,
            ...
            function o() {
              ...
              for (a(e), a(e), e.hunks = []; s < n.length; ) {
                ...
                if (/^@@/.test(c)) e.hunks.push(l());
                  ...
                  if (c && t.strict)
                    throw new Error(
                      "Unknown line " + (s + 1) + " " + JSON.stringify(c),
                    );
                  s++;
                }
              }
        ...
        !(function (e) {
          ...
          (e.tags = {
            ...
            (e.scan = function (n, i) {
              ...
              function v() {
                f.length > 0 &&
                  (u.push({ tag: "_t", text: new String(f) }), (f = ""));
              }
              function y(n, i) {
                if (
                  (v(),
                  n &&
                    (function () {
                      for (var n = !0, i = b; i < u.length; i++)
                        if (
                          !(n =
                            e.tags[u[i].tag] < e.tags._v ||
                            ("_t" == u[i].tag && null === u[i].text.match(t)))
                        )
                          return !1;
                      return n;
                    })())
          ...
          function f(t, n, i, r) {
            ...
            for (s = i[i.length - 1]; t.length > 0; ) {
              ...
              if (e.tags[l.tag] <= e.tags.$ || u(l, r))
                i.push(l), (l.nodes = f(t, l.tag, i, r));
              else {
                if ("/" == l.tag) {
                  if (0 === i.length)
          ...
          function p(e) {
            ...
            return (
              ...
              (function (e) {
                var t = [];
                for (var n in e)
                  t.push('"' + g(n) + '": function(c,p,t,i) {' + e[n] + "}");
                return "{ " + t.join(",") + " }";
              })(e.subs)
            );
          }
          ...
          (e.generate = function (t, n, i) {
            ...
            return (
              e.walk(t, r),
              i.asString ? this.stringify(r, n, i) : this.makeTemplate(r, n, i)
            );
          }),
            ...
            (e.codegen = {
              ...
              $: function (t, n) {
                ...
                e.walk(t.nodes, i),
                  (n.subs[t.n] = i.code),
                  n.inPartial || (n.code += 't.sub("' + g(t.n) + '",c,p,i);');
              },
              "\n": function (e, t) {
                t.code += w('"\\n"' + (e.last ? "" : " + i"));
              },
          ...
          function t(e, t, n) {
            ...
            return (
              t &&
                ...
                (void 0 !== t[e]
                  ? (i = t[e])
                  : n && t.get && "function" == typeof t.get && (i = t.get(e))),
              i
            );
          }
            ...
            (e.Template.prototype = {
              ...
              ep: function (e, t) {
                ...
                if (((this.partials[e].base = i), n.subs)) {
                  ...
                  i = (function (e, t, n, i, r, s) {
                    ...
                    for (l in ((r = r || {}), (c.stackPartials = r), n))
                      r[l] || (r[l] = n[l]);
              ...
              d: function (e, n, i, r) {
                ...
                return (
                  ...
                  (r ||
                    "function" != typeof a ||
                    (n.push(d), (a = this.mv(a, n, i)), n.pop()),
                  a)
                );
              },
              f: function (e, n, i, r) {
                ...
                return o
                  ? (r || "function" != typeof s || (s = this.mv(s, n, i)), s)
                  : !r && "";
              },
      ...
      468: (e, t, n) => {
        ...
        function l(e, t, n) {
          const i = void 0 !== n ? [...a, n] : a,
            s = t
              ? new RegExp(`^${(0, r.escapeForRegExp)(t)} "?(.+?)"?$`)
              : new RegExp('^"?(.+?)"?$'),
            [, o = ""] = s.exec(e) || [],
          ...
          return (
            k.forEach((e, d) => {
              ...
              if (
                ...
                e.startsWith("diff --combined")
              ) {
                if (
                  (I(),
                  (D = /^diff --git "?([a-ciow]\/.+)"? "?([a-ciow]\/.+)"?/.exec(
                    e,
                  )) &&
                    ((u = l(D[1], void 0, t.dstPrefix)),
                    (h = l(D[2], void 0, t.srcPrefix))),
                  null === r)
                )
              ...
              if (
                e.startsWith("Binary files") &&
                !(null == r ? void 0 : r.isGitDiff)
              ) {
                if (
                  (I(),
                  (D =
                    /^Binary files "?([a-ciow]\/.+)"? and "?([a-ciow]\/.+)"? differ/.exec(
                      e,
                    )) &&
                    ((u = l(D[1], void 0, t.dstPrefix)),
                    (h = l(D[2], void 0, t.srcPrefix))),
              ...
              if (
                r &&
                (("number" == typeof t.diffMaxChanges &&
                  r.addedLines + r.deletedLines > t.diffMaxChanges) ||
                  ("number" == typeof t.diffMaxLineLength &&
                    e.length > t.diffMaxLineLength))
              )
                return (
                  (r.isTooBig = !0),
                  (r.addedLines = 0),
              ...
              if (
                (e.startsWith(p) && R.startsWith(b)) ||
                (e.startsWith(b) && F.startsWith(p))
              ) {
                if (
                  r &&
                  !r.oldName &&
                  ...
                  return (
                    (r.oldName = D),
                    void (r.language = s(r.oldName, r.language))
                  );
                if (
                  r &&
                  !r.newName &&
                  ...
                  return (
                    (r.newName = D),
                    void (r.language = s(r.newName, r.language))
                  );
              }
              if (
                r &&
                (e.startsWith(g) ||
                  (r.isGitDiff && r.oldName && r.newName && !a))
              )
                return void A(e);
              if (
                a &&
                ...
                return void (function (e) {
                  if (null === r || null === a || null === c || null === f)
                    return;
                  const t = { content: e },
                    n = r.isCombined ? ["+ ", " +", "++"] : ["+"],
                    s = r.isCombined ? ["- ", " -", "--"] : ["-"];
                  o(e, n)
                    ? (r.addedLines++,
                      (t.type = i.LineType.INSERT),
                      (t.oldNumber = void 0),
                      (t.newNumber = f++))
                    : o(e, s)
                      ? (r.deletedLines++,
                        (t.type = i.LineType.DELETE),
                        (t.oldNumber = c++),
                        (t.newNumber = void 0))
                      : ((t.type = i.LineType.CONTEXT),
                        (t.oldNumber = c++),
                        (t.newNumber = f++)),
                    a.lines.push(t);
                })(e);
                            ...
                            : (D = x.exec(e))
                              ...
                              : (D = _.exec(e))
                                ...
                                : N.test(e)
                                  ? ((r.isBinary = !0), A(e))
                                  : (D = O.exec(e))
                                    ? (r.unchangedPercentage = parseInt(
                                        D[1],
                                        10,
                                      ))
                                    : (D = T.exec(e))
                                      ? (r.changedPercentage = parseInt(
                                          D[1],
                                          10,
                                        ))
                                      : (D = j.exec(e))
                                        ? ((r.checksumBefore = D[1]),
                                          (r.checksumAfter = D[2]),
                                          D[3] && (r.mode = D[3]))
                                        : (D = P.exec(e))
                                          ? ((r.checksumBefore = [D[2], D[3]]),
                                            (r.checksumAfter = D[1]))
                                          : (D = E.exec(e))
                                            ? ((r.oldMode = [D[2], D[3]]),
                                              (r.newMode = D[1]))
            ...
            code: function (e, t, n) {
              ...
              return (
                ...
                i.s(i.f("blockHeader", e, t, 1), e, t, 0, 156, 173, "{{ }}") &&
                  ...
                  e.pop()),
                i.s(i.f("blockHeader", e, t, 1), e, t, 1, 0, 0, "") ||
                  i.b("&nbsp;"),
                i.b("</div>"),
                i.b("\n" + n),
                i.b("    </td>"),
      ...
      834: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.html = t.parse = t.defaultDiff2HtmlConfig = void 0);
        const a = s(n(468)),
          l = n(479),
          c = s(n(378)),
          d = s(n(170)),
        ...
        (t.defaultDiff2HtmlConfig = Object.assign(
          Object.assign(
            Object.assign({}, c.defaultLineByLineRendererConfig),
          ...
          (t.parse = function (e, n = {}) {
            return a.parse(
              e,
              Object.assign(Object.assign({}, t.defaultDiff2HtmlConfig), n),
            );
          }),
          (t.html = function (e, n = {}) {
            const i = Object.assign(
                Object.assign({}, t.defaultDiff2HtmlConfig),
                n,
              ),
            ...
            return (
              ...
              ("side-by-side" === i.outputFormat
                ? new d.default(s, i).render(r)
                : new c.default(s, i).render(r))
            );
          });
      },
      479: function (e, t, n) {
        ...
        const o = s(n(741)),
          a = "file-summary";
        (t.defaultFileListRendererConfig = {
          colorScheme: o.defaultRenderConfig.colorScheme,
        }),
          (t.FileListRenderer = class {
            constructor(e, n = {}) {
              (this.hoganUtils = e),
                (this.config = Object.assign(
                  Object.assign({}, t.defaultFileListRendererConfig),
                  n,
                ));
            }
            render(e) {
              const t = e
                .map((e) =>
                  this.hoganUtils.render(
                    ...
                    {
                      fileIcon: this.hoganUtils.template(
                        "icon",
                        o.getFileIcon(e),
                      ),
                    },
        ...
        t.default = class {
          constructor({ compiledTemplates: e = {}, rawTemplates: t = {} }) {
            ...
            this.preCompiledTemplates = Object.assign(
              Object.assign(Object.assign({}, a.defaultTemplates), e),
              n,
            );
          }
          static compile(e) {
      ...
      378: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.defaultLineByLineRendererConfig = void 0);
        const o = s(n(483)),
          a = s(n(741)),
          l = n(699);
        t.defaultLineByLineRendererConfig = Object.assign(
          Object.assign({}, a.defaultRenderConfig),
          {
        ...
        t.default = class {
          constructor(e, n = {}) {
            (this.hoganUtils = e),
              (this.config = Object.assign(
                Object.assign({}, t.defaultLineByLineRendererConfig),
                n,
              ));
          }
          render(e) {
            const t = e
              .map((e) => {
                ...
                return (
                  (t = e.blocks.length
                    ? this.generateFileHtml(e)
                    : this.generateEmptyDiff()),
          ...
          makeFileDiffHtml(e, t) {
            ...
            return n.render({
              ...
              diffs: t,
              filePath: i.render(
                { fileDiffName: a.filenameDiff(e) },
                { fileIcon: r, fileTag: s },
              ),
            });
          }
          generateEmptyDiff() {
          ...
          generateFileHtml(e) {
            const t = o.newMatcherFn(
              o.newDistanceFn(
                (t) => a.deconstructLine(t.content, e.isCombined).content,
              ),
            );
            return e.blocks
              .map((n) => {
                let i = this.hoganUtils.render(c, "block-header", {
                  CSSLineClass: a.CSSLineClass,
                  blockHeader: e.isTooBig
                    ? n.header
                    : a.escapeForHtml(n.header),
                  ...
                  this.applyLineGroupping(n).forEach(([n, r, s]) => {
                    if (r.length && s.length && !n.length)
                      this.applyRematchMatching(r, s, t).map(([t, n]) => {
                        const { left: r, right: s } = this.processChangedLines(
                          e,
                          e.isCombined,
                          t,
                          n,
                      ...
                      n.forEach((t) => {
                        const { prefix: n, content: r } = a.deconstructLine(
                          t.content,
                          e.isCombined,
                        );
                      ...
                      const { left: t, right: n } = this.processChangedLines(
                        e,
                        e.isCombined,
                        r,
                        s,
          ...
          applyLineGroupping(e) {
            ...
            for (let r = 0; r < e.lines.length; r++) {
              const s = e.lines[r];
              ((s.type !== l.LineType.INSERT && i.length) ||
                (s.type === l.LineType.CONTEXT && n.length > 0)) &&
                (t.push([[], n, i]), (n = []), (i = [])),
          ...
          applyRematchMatching(e, t, n) {
            const i = e.length * t.length,
              r = Math.max.apply(
                null,
                [0].concat(e.concat(t).map((e) => e.content.length)),
              );
            return i < this.config.matchingMaxComparisons &&
              r < this.config.maxLineSizeInBlockForComparison &&
              ("lines" === this.config.matching ||
                "words" === this.config.matching)
              ? n(e, t)
              : [[e, t]];
          }
          processChangedLines(e, t, n, i) {
            ...
            for (let o = 0; o < s; o++) {
              const s = n[o],
                ...
                c =
                  void 0 !== s && void 0 !== l
                    ? a.diffHighlight(s.content, l.content, t, this.config)
                    : void 0,
                d =
              ...
              const o = (function (t, n, i = new Map()) {
                ...
                for (let o = 0; o < t.length; ++o)
                  for (let a = 0; a < n.length; ++a) {
                    ...
                    let c;
                    (i.has(l) && (c = i.get(l))) ||
                      ((c = e(t[o], n[a])), i.set(l, c)),
                      c < s &&
                        ((s = c), (r = { indexA: o, indexB: a, score: s }));
                  }
                return r;
              })(n, i, s);
      ...
      741: function (e, t, n) {
        ...
        function g(e, t, n = !0) {
          ...
          return {
            ...
            content: n ? b(e.substring(i)) : e.substring(i),
          };
        }
        function m(e) {
        ...
        (t.toCSSClass = function (e) {
          ...
          (t.diffHighlight = function (e, n, i, r = {}) {
            ...
            const m =
                "char" === c
                  ? o.diffChars(d.content, h.content)
                  : o.diffWordsWithSpace(d.content, h.content),
              v = [];
            if ("word" === c && "words" === s) {
      ...
      170: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.defaultSideBySideRendererConfig = void 0);
        const o = s(n(483)),
          a = s(n(741)),
          l = n(699);
        t.defaultSideBySideRendererConfig = Object.assign(
          Object.assign({}, a.defaultRenderConfig),
          {
            renderNothingWhenEmpty: !1,
            matchingMaxComparisons: 2500,
        ...
        t.default = class {
          constructor(e, n = {}) {
            (this.hoganUtils = e),
              (this.config = Object.assign(
                Object.assign({}, t.defaultSideBySideRendererConfig),
                n,
              ));
          }
          render(e) {
          ...
          generateFileHtml(e) {
            ...
            return e.blocks
              ...
              .reduce(
                (e, t) => ({ left: e.left + t.left, right: e.right + t.right }),
                { left: "", right: "" },
              );
          }
          applyLineGroupping(e) {
          ...
          makeHeaderHtml(e, t) {
            return this.hoganUtils.render(c, "block-header", {
              CSSLineClass: a.CSSLineClass,
              blockHeader: (null == t ? void 0 : t.isTooBig)
                ? e
                : a.escapeForHtml(e),
          ...
          processChangedLines(e, t, n) {
            ...
            for (let s = 0; s < r; s++) {
              const r = t[s],
                ...
                l =
                  void 0 !== r && void 0 !== o
                    ? a.diffHighlight(r.content, o.content, e, this.config)
                    : void 0,
                c =
          ...
          generateSingleHtml(e) {
            ...
            return this.hoganUtils.render(c, "line", {
              type:
                ...
                `${a.CSSLineClass.CONTEXT} d2h-emptyplaceholder`,
              lineClass:
                void 0 !== e ? t : `${t} d2h-code-side-emptyplaceholder`,
              contentClass:
                void 0 !== e ? n : `${n} d2h-code-side-emptyplaceholder`,
              prefix:
      ...
      593: (e, t) => {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.hashCode = t.unifyPath = t.escapeForRegExp = void 0);
        const n = RegExp(
          "[" +
            [
              "-",
